...
export const translations = {
  ...
  en: {
    ...
    footer: {
      ...
      newsletterDesc: "Subscribe to receive our latest news.",
  ...
  es: {
    ...
    footer: {
      ...
      newsletter: "Boletín",
      newsletterDesc: "Suscríbete para recibir nuestras últimas noticias.",
    ...
    contact: {
      ...
      formSubtitle: "Le responderemos lo antes posible",
